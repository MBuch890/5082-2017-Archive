...
public class pipeline implements VisionPipeline {
	...
	public void process(Mat source0) {
		...
		double[] rgbThresholdRed = {0.0, 120.16701980403515};
		double[] rgbThresholdGreen = {41.36909921833186, 181.02389078498294};
		double[] rgbThresholdBlue = {33.63309206722452, 164.60803345571645};
		rgbThreshold(rgbThresholdInput, rgbThresholdRed, rgbThresholdGreen, rgbThresholdBlue, rgbThresholdOutput);

		// Step Blur0:
		Mat blurInput = rgbThresholdOutput;
		BlurType blurType = BlurType.get("Median Filter");
		double blurRadius = 4.204204920175913;
